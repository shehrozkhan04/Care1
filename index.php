						...
						<div class="single-schedule first">
							<div class="inner">
								...
								<div class="single-content">
									...
									<p>Transforming Healthcare with Compassion, Trust, and World-Class Expertise.</p>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-12">
						...
						<div class="single-schedule middle">
							<div class="inner">
								...
								<div class="single-content">
									<span>CARE</span>
									<h4>Doctors Vision</h4>
									<p>Your Health, Our Mission – Delivering Advanced Care with a Personal Touch.
							...
							<div class="inner">
								...
								<div class="single-content">
									...
									<ul class="time-sidual">
										<li class="day">Monday - Saturday <span>24 Hours</span></li>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="section-title">
						...
						<p>Comprehensive Care, Advanced Services – Because Your Health Deserves the Best.</p>
					</div>
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				<div class="col-lg-6 col-12">
					...
					<div class="choose-left">
						<h3>Who We Are</h3>
						<p>At Care, we believe that healthcare is more than just treating illnesses—it’s about
							transforming lives, building trust, and fostering wellness. As a dedicated healthcare
							institution, we have been committed to delivering exceptional medical services designed to
							meet the diverse needs of our patients with compassion, precision, and excellence.</p>

						<p>With a team of highly skilled doctors, nurses, and healthcare professionals, Care is a place
							where expertise meets empathy. We take pride in offering a wide range of services, from
							preventive care to advanced diagnostics, surgical interventions, and personalized treatment
							plans. Our state-of-the-art facilities are equipped with cutting-edge technology to ensure
							that every patient receives the best care possible in a safe and comfortable environment.
						</p>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-12">
					<div class="content">
						...
						<p>In Case of an Emergency, Call Us Anytime – We're Here for You 24/7.</p>
						<div class="button">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="section-title">
						...
						<img src="img/section-img.png" alt="#">
						<p>At Care, we prioritize hygiene as the cornerstone of safe and effective healthcare. Our
							strict sanitation protocols ensure a clean, safe, and healing environment for every patient.
						</p>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-12 col-12">
					<div class="owl-carousel portfolio-slider">
						<div class="single-pf">
							...
							<a href="services.php" class="btn">View Details</a>
						</div>
						<div class="single-pf">
					...
					<div class="col-lg-4 col-md-12 col-12">
						<div class="single-table">
							...
							<div class="table-bottom">
								<a class="btn" href="services.php">View Details</a>
							</div>
							<!-- Table Bottom -->
						</div>
					</div>
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="section-title">
									...
									<img src="img/section-img.png" alt="#">
									<p>Stay Informed with the Latest Medical Advancements and Health Tips from Our
										Experts.</p>
								</div>
							</div>
						</div>
								...
								<div class="single-news">
									...
									<div class="news-body">
										<div class="news-content">
											...
											<h2><a href="blog-single.php">Introducing Our Latest Health Innovation: A
													Revolutionary Treatment</a></h2>
											<p class="text">We are excited to announce the launch of our newest
												treatment, designed to enhance patient recovery and improve overall
												health outcomes.</p>
										</div>
									</div>
								</div>
								...
								<div class="single-news">
									...
									<div class="news-body">
										<div class="news-content">
											...
											<h2><a href="blog-single.php">Top Five Ways to Prevent and Treat Common
													Dental Issues</a></h2>
											<p class="text">Learn about the best practices for maintaining optimal oral
												health, including tips for preventing cavities, gum disease, and other
												dental problems.</p>
										</div>
									</div>
								</div>
								...
								<div class="single-news">
									...
									<div class="news-body">
										<div class="news-content">
											...
											<h2><a href="blog-single.php">Understanding Heart Health: Key Tips for a
													Stronger Heart</a></h2>
											<p class="text">Discover essential advice for maintaining heart health,
												including lifestyle changes, dietary recommendations, and preventive
												treatments to reduce the risk of cardiovascular disease.</p>
										</div>
									</div>
								</div>
								<!-- End Single Blog -->
						...
						<div class="row ">
							<div class="col-lg-6  col-12">
								...
								<div class="subscribe-text ">
									...
									<p>Stay up-to-date with the latest health tips, medical news, and exclusive offers
