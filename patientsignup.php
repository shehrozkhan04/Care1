...
<body>
    ...
    <div class="signup">
        <form class="signup-form" action="/submit-patient-signup" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="file" id="upload-medical-reports" name="medical_reports" accept=".pdf,.doc,.docx" required>
            </div>
